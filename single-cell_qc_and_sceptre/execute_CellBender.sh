...
pool_ref=/mnt/isilon/sfgi/conerym/analyses/grant/crispri_screen/full_hFOB_screen_bone/Grant_hFOB_CRISPRi/single-cell_qc_and_sceptre/cellbender_counts.txt #File of manually estimated cell counts
