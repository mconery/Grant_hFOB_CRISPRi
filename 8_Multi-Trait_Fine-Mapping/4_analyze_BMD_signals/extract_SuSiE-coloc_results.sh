...
python $combination_script --directory $susie_coloc_dir --naming_convention "chr*.susie-coloc.tsv" --output $susie_coloc_dir/master.susie-coloc.tsv --set_rows=False
